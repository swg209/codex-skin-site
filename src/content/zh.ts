...
export const zhContent: LocaleContent = {
  ...
  siteRepositoryLabel: "CodexSkin 网站源码",
    ...
    disclaimer: "OpenAI 与 Codex 是 OpenAI 使用的名称和标识。CodexSkin.site 是独立的编辑与外观定制网站，与 OpenAI 没有隶属、认可、赞助或运营关系。第三方项目的代码和素材归各自权利人及贡献者所有。",
    infoLabels: {
      about: "关于本站",
      contact: "联系我们",
      privacy: "隐私政策",
  ...
  home: {
    ...
    createLook: {
      ...
      description: "先了解同一张背景图兼顾首页与任务页时应遵循的构图规则，再确认独立视觉层的工作方式和安全边界。",
      browseLabel: "阅读背景图指南",
      createLabel: "了解 Dream Skin",
    ...
    features: [
      ...
      { title: "本机运行时样式层", description: "主题辅助进程通过仅绑定回环地址的调试端点连接预期的 Codex 渲染页面，并在运行时应用视觉 CSS。" },
    ],
    ...
    faqTitle: "常见问题",
    faq: [
      { question: "Codex Dream Skin 是什么？", answer: "它是一个开源视觉主题层，通过 CDP 连接用户在本机启动的 Codex 桌面端会话，并在运行时应用 CSS 和装饰界面元素。" },
  ...
  dreamSkin: {
    ...
    overviewParagraphs: [
      ...
      "它不同于 Codex 内置外观选项：项目通过 Chrome DevTools Protocol（CDP）连接到本机启动的 Codex 会话，并在运行时应用主题样式和装饰元素。",
    ],
    workflowTitle: "视觉主题层如何工作",
    workflowSteps: ["Codex 桌面端", "本机 CDP 连接", "运行时应用主题与背景", "定制后的外观"],
  ...
  guides: {
    windows: {
      ...
      sections: [
        ...
        { id: "verify", title: "验证主题", blocks: [{ type: "code", language: "powershell", code: ".\\scripts\\verify-dream-skin.ps1 -ScreenshotPath \"$env:USERPROFILE\\Desktop\\codex-dream-skin.png\"" }, { type: "paragraph", text: "同时检查主页和普通任务页。缺少横幅、原生输入框、侧栏主题或运行时样式标记都属于验证失败。" }] },
    ...
    restore: {
      ...
      eyebrow: "恢复教程",
      h1: "恢复 Codex 官方外观",
      summary: "使用对应平台记录的恢复流程，停止主题辅助进程、关闭本机 CDP 会话并重新打开官方应用。",
      ...guideAttribution,
      sourceLabel: "查看原始项目",
      issueLabel: "查看上游问题",
      copyLabel: "复制",
